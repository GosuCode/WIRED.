...
const Analytics = () => {
    ...
    return (
        <div className="pl-5 grid place-items-center">
            <div className="grid w-full mt-24 grid-cols-12 px-3 gap-3 md:gap-12 md:px-12 text-black place-items-center">
                {stats.map((val, key) => {
                    return (
                        <div
                            key={key}
                            className="bg-white col-span-3 w-[80%] cursor-pointer rounded-lg h-20 grid place-items-center md:shadow-neon shadow-green"
                        >
            ...
            <hr className="bg-white text-white w-full h-1 mt-14 " />
            <div className="w-full grid place-items-center pt-10">
                <DoughnutChart />
            </div>
            <hr className="bg-white text-white w-full h-1 mt-20 " />
            ...
            <hr className="bg-white text-white w-full h-1 mt-20 " />
            <div className="mt-20 h-[450px] w-[1000px] px-14  border-2 rounded-md border-cyan-200 mb-32">
